...
>> If you want to pick random IP address then you can find open ports here [RANDOM IP ADDRESS](https://shodan.io) and search `Android debug system`and pick random IP address
